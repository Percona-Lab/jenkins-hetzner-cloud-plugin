...
public class ConfigurationValidator {
    /**
     * Simple validation of credentialsId. This is implemented by listing the first location.
     *
    ...
    static ValidationResult validateCloudConfig(String credentialsId) {
        return validateWithClient(api -> {
            final GetLocationsResponse result = api.getAllLocations(1, 1).execute().body();
